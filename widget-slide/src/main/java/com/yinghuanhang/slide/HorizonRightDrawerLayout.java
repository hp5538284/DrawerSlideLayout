...
/**
 * Created by Cao-Human on 2017/3/1
 */
public class HorizonRightDrawerLayout extends HorizonDrawerLayout {
    public HorizonRightDrawerLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public HorizonRightDrawerLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public HorizonRightDrawerLayout(Context context) {
        super(context);
    }
    ...
    public boolean onDown(View view, MotionEvent event) {
        ...
        int area = getArea();
        if (event.getX() >= content.getRight() - area && event.getX() <= content.getRight() + area) {
